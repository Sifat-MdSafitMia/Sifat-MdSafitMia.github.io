...
export default function Home() {
  return (
    <div className="mt-5 mx-3 md:px-10 py-5 w-full flex flex-col items-center justify-center">
      ...
      <div className="font-semibold text-md w-30 flex items-center justify-center py-3 px-5 text-white hover:text-gray-700 hoverbg-transparent duration-500 bg-gray-700 rounded-3xl border-[.5px] hover:border-gray-700 border-amber-200"><Link href='/contact' className="">Contact</Link></div>
